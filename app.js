...
// "this" is referring to the specific object "joe" thats calling the "scope" function.
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" isn't referring to the object "joe" specifically. In this case, "this" is getting its identity from a global object that isn't defined in this code snippet.
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not have their own "this" context, like "this" would in a standard function. Arrow functions borrow their "this" identity from around the place they're written.
